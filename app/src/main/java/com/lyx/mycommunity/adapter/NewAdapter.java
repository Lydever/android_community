...
public class NewAdapter extends BaseAdapter {
    ...
    public NewAdapter(Context context, List<NewsBean.ResultBean.DataBean> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (getItemViewType(position) == IMAGE_01){
            ...
            if (convertView == null){
                convertView =View.inflate(context, R.layout.new_item_imglayout01,null);
            ...
            if (convertView == null){
                convertView =View.inflate(context, R.layout.new_item_imglayout02,null);
            ...
            if (convertView == null){
                convertView =View.inflate(context, R.layout.new_item_imglayout03,null);
